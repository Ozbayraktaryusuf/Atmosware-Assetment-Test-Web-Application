...
public class UserRoleManagerTest {
    ...
    void add_ShouldCreateUserRole() {
        ...
        // Act
        CreateUserRoleResponse response = userRoleManager.add(createUserRoleRequest);
    ...
    void update_ShouldUpdateUserRole() {
        ...
        // Act
        UpdateUserRoleResponse response = userRoleManager.update(userRoleId, updateUserRoleRequest);
